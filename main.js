var x = "9_48x48.png";var o = "11_48x48.png";
var blank = "20_48x48.png";var pause = 0;var all = 0;var a = 0;var b = 0;
...
process();}
function ended() {alert("To start a new game, click.")}
function process() {
logicOne();
if (all==1){ alert("You won! Congratulations!"); wn++; }
if (all==2){ alert("You lose."); ls++; }
if (all==3){ alert("We played in a draw."); ts++; }
if (all!=0) {
document.game.you.value = wn;
document.game.computer.value = ls;
document.game.ties.value = ts;}}
function playAgain() {
if (all==0) {if(confirm("Who will account reset and start a new tour.")) reset();}
if (all>0) reset();}
function reset() {
